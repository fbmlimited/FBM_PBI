page 61131 FBM_GetsiteLocMX_PBI
{
    Caption = 'Get Local Site MX';
    PageType = API;
    APIGroup = 'app1';
    APIPublisher = 'FBMGroup';
    EntitySetName = 'SiteLocMX';
    EntityName = 'SiteLocMX';
    ...
    begin
        ...
        rec.CalcFields("Country/Region Code_FF");
        rec.SetRange("Country/Region Code_FF", 'MX');
    end;
